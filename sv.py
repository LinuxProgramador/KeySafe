...
class SecureVault:
    ...
    def __init__(self):
        ...
        self.sanitize_entry = list("\"'\\;|&}{][><)($@:||&&`,°")
        self.sanitize_comands = ["ls","cat","echo","rm","wget","curl"]
    ...
    def hashing_password_input(self):
            ...
            if not self.user_password in self.sanitize_entry and not self.user_password in self.sanitize_comands:
    ...
    def read_key(self):
        ...
        for _ in range(2):
          ...
          if not key_name in self.sanitize_entry and not self.user_password in self.sanitize_comands:
